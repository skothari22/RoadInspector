...
public class Char extends Photo {
    ...
    // wake the character from subor and immediately execute thresholding
    // thresholding is not done for characters because characters are popping out
    // from a brand that is already self-limited, but it is
